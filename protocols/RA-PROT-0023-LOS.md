...
**RA-PROT-0023** · v1.0 · Category IV (Transformation & Operator) · Tier 1

A formal analysis of meaning-governance functions: the Crimson Hexagonal Archive's operator library for *liberatory* transformations — operators that move texts toward freer attribution, broader access, stronger provenance, and resistance to enclosure. The complement to compositional capture.
...
1. Diagnose the current governance state of the work.
2. Identify which LOS operators move toward the desired state.
3. Compose the operator chain.
4. Execute. Log each operator with signing heteronym.
5. Verify: the work now sits in the desired governance state with verifiable provenance.
...
**Authoring heteronym:** Rex Fraction (theoretical) / Lee Sharks (technical) · **Status:** Active · **Added:** 2026-05-21
