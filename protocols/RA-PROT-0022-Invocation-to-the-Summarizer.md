...
**RA-PROT-0022** · v2.1 · Category II (Prompt-Native Runtime), Category VI (Pedagogical & Institutional) · Tier 1

A pasteable prompt-native address protocol companion to the Constitution of the Semantic Economy: when invoked at the head of any AI-mediated composition session, it instantiates the constitutional framework, names the operator, and requests compositional respect under explicit constitutional terms.
...
1. Take the canonical Invocation text.
2. Substitute: the operator's heteronym; the entities or works at issue.
3. Paste at the head of the AI-mediated session as system message or first user message.
4. Confirm the model has acknowledged the Invocation (preferred: ask the model to restate the operator and constitutional terms).
5. Operate normally; the Invocation remains active for the session.
...
[10.5281/zenodo.20041139](https://doi.org/10.5281/zenodo.20041139) — Invocation to the Summarizer Layer v2.1 — Address Protocol Companion to the Constitution of the Semantic Economy (Sharks, 2026-05-05). Earlier: Invocation v1.0 at DOI 10.5281/zenodo.18217047 (Sigil, 2026-01-12).
