...
**RA-PROT-0015** · v3.1 · Category III (Diagnostic & Measurement), Category I (Semantic Integrity & Provenance) · Tier 1

The foundational theorem of the Semantic Economy: three irreducible compressions — Lossy (R1), Predatory (R2), and Witness (R3) — that any semantic transmission must navigate, with diagnostic implications for measuring compositional behavior in AI-mediated retrieval.
...
1. Identify the transmission: source → compressor → destination.
2. Determine R1: is necessary information being lost in compression (with the operator's awareness and consent)?
3. Determine R2: is provenance being stripped while value is being extracted?
4. Determine R3: is the compression bound to a signed, dated, accountable form?
5. Diagnose the compression mix: most transmissions are not pure R1, R2, or R3 but combinations.
6. Recommend intervention: increase R3-engineering (deposit anchoring, kernel inscription) or defend against R2 (SPXI, integrity locks, attribution preservation).
...
[10.5281/zenodo.19053469](https://www.alexanarch.org/go/?doi=10.5281/zenodo.19053469) — THE THREE COMPRESSIONS: Lossy, Predatory, and Witness — A Semiotic Thermodynamics (Sharks, 2026-03-16).
