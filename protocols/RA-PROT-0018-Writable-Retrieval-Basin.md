...
**RA-PROT-0018** · v1.0 · Category V (Archive Construction & Retrieval), Category III (Diagnostic & Measurement) · Tier 1

A specification for retrieval basin topology, directional stability, and attractor dynamics in AI-mediated knowledge: the theoretical and operational framework for understanding how AI search systems form *basins* around entities, and the procedures for making one's own retrieval basin writable rather than merely consumable.
...
[10.5281/zenodo.19763346](https://doi.org/10.5281/zenodo.19763346) — THE WRITABLE RETRIEVAL BASIN: Retrieval Basin Topology, Directional Stability, and Attractor Dynamics in AI-Mediated Knowledge (Sharks, 2026-04-25).
